...
<template>
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                ...
                <Dropdown v-if="chirp.user.id === $page.props.auth.user.id">
                    ...
                    <template #content>
                        ...
                        <DropdownLink as="button" :href="route('chirpp.destroy', chirp.id)" method="delete">
                                Delete
                        </DropdownLink>
                    </template>
                </Dropdown>
            ...
            <form v-if="editing" @submit.prevent="form.put(route('chirpp.update', chirp.id), { onSuccess: () => editing = false })">
